...
in {
  ...
  // lib.mapAttrs' (n: lib.nameValuePair ("linux--nanos--" + n)) (builtins.removeAttrs perSystem.x86_64-linux.nanos ["test-with-logging" "stack-check" "stack-check-with-logging"])
  ...
  // lib.mapAttrs' (n: lib.nameValuePair ("macos--nanos--" + n)) (builtins.removeAttrs perSystem.x86_64-darwin.nanos ["test-with-logging" "stack-check" "stack-check-with-logging"])
